      ...
      <div class="card-body">
          <div class="content-wrapper">
              ...
              <div class="content-header">
                      <div class="row mb-2">
                          <div class="col-sm-6">
                              <h3 class="m-0">Data Buku Hilang dan Rusak</h3>
                          </div><!-- /.col -->
                          <div class="col-sm-6">
                              <ol class="breadcrumb float-sm-right">
                                  <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                  <li class="breadcrumb-item active">Data Buku Hilang dan Rusak</li>
                              </ol>
                          </div><!-- /.col -->
                      </div><!-- /.row -->
              </div>
                      ...
                      <table class="table table-hover">
                          <thead>
                              <tr>
                                  ...
                                  <th class="px-6 py-2">Buku</th>
                                  <th class="px-6 py-2">Keteterangan</th>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td class="px-6 py-2"><b>
                                    ...
                                    <p class="text-body mt-2"></b>Penerbit: {{ $item->masterbuku->publisher }}</p>
                                </td>
