          ...
          <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <div class="row g-3 align-items-center mb-4">
                      <div class="col-auto">
                          <form action="reqbuku" method="GET">
                      ...
                      {{-- Button Export PDF --}}
                      <div class="col-auto">
                          <a href="{{ route('reqbuku.create')}}" class="btn btn-success">
                              Tambah Data
                          </a>
                          {{-- <a href="{{ route('reqbukupdf')}}" class="btn btn-danger">
                              Export PDF
                          </a> --}}
                      </div>
                  </div>
                  ...
                  <div>
                      <table class="table table-hover">
                          ...
                          <tbody>
                              ...
                              $no=1;
                              @endphp
                              @foreach ($reqbuku as $index => $item)
                              <tr>
                                  <th class="px-6 py-2">{{ $index + $reqbuku->firstItem() }}</th>
                                  ...
                                  <td>
                                      ...
                                      <form action="{{ route('reqbuku.destroy', $item->id) }}" method="POST" style="display:inline;">
                                          @csrf
                                          @method('delete')
