...
<title>Data Peminjaman E-Book</title>
...
<body>
    <div class="container-fluid">
        <div class="card" style="border-radius: 15px;">
          <div class="card-body">
              <h1 class="text-center mb-4">Edit Data Peminjaman E-Book</h1>
              <div class="container">
                              ...
                              <div class="card-body">
                                  <form method="POST" action="{{ route('peminjaman.update', $item->id) }}" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="form-select" name="id_ebook" id="judulbuku" data-placeholder="PILIH JUDUL BUKU">
                                            <option></option>
