            ...
            <div class="card-body">
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Data Riwayat Peminjaman Siswa</h3>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Data Riwayat Peminjaman Siswa</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div>
                                ...
                                @else
                                    @foreach ($peminjaman->unique('id_anggota') as $item)
                                        <option value="{{ $item->id_anggota }}"
                                            ...
                                            {{ strtoupper($item->masteranggota->user->name) }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <tbody>
                        @foreach ($peminjaman as $index => $item)
                            <tr>
                                ...
                                <td class="px-6 py-2"><b>{{ $item->masteranggota->user->name }}</b></td>
                                <td class="px-6 py-2">
