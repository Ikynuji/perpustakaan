                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('peminjaman.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group" style="border-radius: 8px;">
                                                ...
                                                <input type="number" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" style="border-radius: 8px;" placeholder="qty" value="{{ old('jumlah') }}" required>
                                                @error('jumlah')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
